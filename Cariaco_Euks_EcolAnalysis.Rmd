...
Re-load
```{r}
load("../../DatasetBackupv2/CariacoEuks_postanalysis_vars_upto_tree.RData")
```
...
# export
ggsave("../../../Figures/PostAnalysisv2/Division_barplot.eps",Division_barplot, width = 15, height = 5, units = c("in"))
```

**STOPPED HERE- MAKE BUBBLE PLOTS**
