...
Update Oct 2021- also added some lines to pull out top 100 and top 150 OTUs/ ASVs in order to later normalize network analyses for network size
...
# do same but make a top 300 otu table (top 100 from each domain)
...
## 10/27 STOPPED HERE
SAVED DATASET AS 
save.image("EnvironmentBackups/CariacoEuks_postanalysis_vars_revisions2.RData")
